...
def main():
    ...
    parser.add_argument('--charLex', type=str, default="./Corpus/CharListFrmC4P.txt",
                        help='location of the char lexicon file')
    parser.add_argument('--pyLex', type=str, default="./Corpus/pinyinList.txt", #"./Corpus/ModernChineseLexicon4PinyinMapping.txt" 
                        help='location of the pinyin list')
    parser.add_argument('--pinyin2PhrasePath', type=str, default="./Corpus/ModernChineseLexicon4PinyinMapping.txt",
    ...
    parser.add_argument('--bigramModelPath', type=str, default="./Models/Bigram/Bigram_CharListFrmC4P.json",
                        help='location of char bigram file')
    parser.add_argument('--modelPath', type=str, default="./Models/pert_tiny_py_lr5e4_10Bs_1e/",
                        help='this is the path to bert model which contains the model file and the config file')
    parser.add_argument('--charFile', type=str, default="./Corpus/PERT_title_Chinese_oct.txt",
                        help='location of the char corpus')
    parser.add_argument('--pinyinFile', type=str, default="./Corpus/PERT_title_pinyin_oct.txt",
                        help='location of the pinyin corpus')
    parser.add_argument('--conversionRsltFile', type=str, default="./Logs/Eval_ConvertRslt_DWAVE_oct_20221208.txt",
                        help='this is the file to contain the conversion result')
    parser.add_argument('--logFile', type=str, default="./Logs/Eval_Rslt_DWAVE_oct_20221208.txt",
    ...
    pinyinList = ['nu', 'ren', 'gong', 'cheng', 'yuan', 'yuan', 'shi', 'zhong', 'nan', 'shan', 'jiu', 'jin', 'qi', 'de', 'xiang', 'gang', 'yi', 'qing', 'fa', 'zhan', 'ji', 'fang', 'kong', 'cuo', 'shi', 'deng', 'wen', 'ti', 'hui', 'da', 'ji', 'zhe', 'ti', 'wen', 'shi']
